...
#define DEFAULT_LOCATION	  "43.473715,-79.649438"  // Oakville, Ont, Canada
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
// JRJ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ //
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
#define DEFAULT_DEVICE_NAME       "OpenSprinkler HA-RPI4B"
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
// JRJ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ //
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  // HydroSys4 HAT Rex 10.4 Pins Used: [5,6,12,13,19,16,26,20,  14,4,15,18,17,27,23,22,  21,24,25]  21=Interrupt, 24=Sensor, 25=Sensor

	#define OS_HW_VERSION    OSPI_HW_VERSION_BASE
  
	#define PIN_SR_LATCH      0     // was 22, 0=Demo Mode, This pin is needed for the HydroSys4 HAT, shift register latch pin
	#define PIN_SR_DATA       0     // was 27, 0=Demo Mode, This pin is needed for the HydroSys4 HAT, shift register data pin
	#define PIN_SR_DATA_ALT   0     // was 21, 0=Demo Mode, This pin is needed for the HydroSys4 HAT, shift register data pin (alternative, for RPi 1 rev. 1 boards)
	#define PIN_SR_CLOCK      0     // was  4, 0=Demo Mode, This pin is needed for the HydroSys4 HAT, shift register clock pin
	#define PIN_SR_OE         0     // was 17, 0=Demo Mode, This pin is needed for the HydroSys4 HAT, shift register output enable pin
	#define PIN_SENSOR1       24    // was 14, 0=Demo Mode, Rain Sensor 1
	#define PIN_SENSOR2       25    // was 23, 0=Demo Mode, Rain Sensor 2
	#define PIN_RFTX          0     // was 15, 0=Demo Mode, This pin is needed for the HydroSys4 HAT, RF transmitter pin
  ...
  #define GPIO22                  22
	...
	#define PIN_FREE_LIST         {4, 5, 6, 12, 13, 14, 15, 16, 17, 18, 19, 20, 22, 23, 26, 27, 24, 25}   // free GPIO pins avavilable for configuration in OpenSprinkler
	//#define PIN_FREE_LIST       {5,6,12,13,16,17,19,20,22,23,26,27}
	//#define PIN_FREE_LIST       {5,6,7,8,9,10,11,12,13,16,18,19,20,21,23,24,25,26}  // free GPIO pins
	#define ETHER_BUFFER_SIZE   16384
